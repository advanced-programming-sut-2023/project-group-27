...
public enum SoldierType {
    SPEARMAN("SpearMan", 0, 0, 1.2, 0, 8, "european",
            new GoodsType[] {GoodsType.SPEAR}),
    PIKEMAN("PikeMan", 0, 0, 1.0, 0, 20, "european",
            new GoodsType[] {GoodsType.ARMOUR, GoodsType.PIKE}),
    MACEMAN("MaceMan", 0, 0, 2.0, 0, 20, "european",
            new GoodsType[] {GoodsType.LEATHER_ARMOUR, GoodsType.MACE}),
    SWORDSMAN("SwordsMan", 0, 0, 1.0, 0, 40, "european",
            new GoodsType[] {GoodsType.ARMOUR, GoodsType.SWORD}),
    KNIGHT("Knight", 0, 0, 2.5, 0, 40, "european",
            new GoodsType[] {GoodsType.ARMOUR, GoodsType.SWORD, GoodsType.HORSE}),
    BLACKMONK("BlackMonk", 0, 0, 2.2, 0, 10, "church", null),
    TUNNELER("Tunneler", 0, 0, 2.1, 0, 30, "guild", null),
    LADDERMAN("LadderMan", 0, 0, 1.8, 0, 3, "guild", null),
    SLAVE("Slave", 0, 0, 1.5, 0, 5, "arab", null),
    ASSASSIN("Assassin", 0, 0, 3.0, 0, 60, "arab", null),
    ARABSWORDSMAN("ArabSwordsMan", 0, 0, 0.8, 0, 80, "arab", null),
    ARCHER("Archer", 0, 0, 1.5, 10, 12, "european",
            new GoodsType[] {GoodsType.BOW}),
    CROSSBOWMAN("CrossBowMan", 0, 0, 1.2, 10, 20, "european",
            new GoodsType[] {GoodsType.CROSSBOW, GoodsType.LEATHER_ARMOUR}),
    ARCHERBOW("ArcherBow", 0, 0, 1.2, 10, 75, "arab", null),
    SLINGER("Slinger", 0, 0, 1.0, 0, 12, "arab", null),
    HORSEARCHER("HorseArcher", 0, 0, 3.5, 10, 60, "arab", null),
    FIRETHROWER("FireThrower", 0, 0, 1.0, 0, 100, "arab", null),
